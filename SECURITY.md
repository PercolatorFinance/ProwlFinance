...
If you've found a vulnerability in the AleaStrategies protocol, **do not open a public issue**. We'd rather hear about it first.
...
Responsible reporters are eligible for bounties from the AleaStrategies treasury under our forthcoming bug bounty program. The amount scales with severity and quality of the report.
